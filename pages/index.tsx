...
export default function Home() {
  return (
    <div className="w-vw max-w-full flex flex-col p-6 justify-center align-center justify-items-center content-center items-center self-center place-content-center justify-self-center min-h-screen gap-6">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-10 align-center justify-center ">
        <Form />
        <div className="relative w-fit max-h-fit m-0 p-0 w-80 h-96 md:w-[416px] md:h-[506px] flex items-center justify-center">
